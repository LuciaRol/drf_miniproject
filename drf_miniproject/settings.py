"""
Django settings for drf_miniproject project.
"""
...
SECRET_KEY = 'django-insecure-5i^5wh533cd^@erzdcr(i!zu@%brxw015-m00u%o30^v-r*29u'
DEBUG = True
ALLOWED_HOSTS = []
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Asegúrate de que esta URL coincida con el origen de tu frontend
]

ROOT_URLCONF = 'drf_miniproject.urls'
